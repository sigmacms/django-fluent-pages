...
setup(
    ...
    install_requires=[
        ...
        'django-polymorphic-tree>1.2.5,<1.3',    # Enforce Python 3 compatible versions
    ...
    extras_require={
        ...
        'fluentpage': ['django-fluent-contents==1.0.2'], # django-fluent-contents is pinned for now.
